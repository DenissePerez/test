    ...
    <div class="card">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="card-content">
                <div class="card-title">{% blocktrans %}Está seguro que desea eliminar {{ object }} y lo relacionado a él?{% endblocktrans %}</div>
            ...
            <div class="card-action">
                <div class="right-align">
                    <button type="submit" class="waves-effect waves-light btn red white-text">{% trans "Sí, estoy seguro" %}</button>
                </div>
            </div>
        </form>
    </div>
