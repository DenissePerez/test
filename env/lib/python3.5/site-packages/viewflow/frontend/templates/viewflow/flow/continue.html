        ...
        <form role="form" method="POST">
            ...
            <div class="card-action row">
                <div class="col s12 right-align">
                    <button type="submit" name="_start" class="btn btn-flat hide-on-small-only">Guardar y Salir del proceso</button>
                    <button type="submit" name="_continue" class="btn primary white-text btn-flat">Siguiente </button>
                </div>
            </div>
        </form>
    </div>
