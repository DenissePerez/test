...
{% load viewflow viewflow_frontend material_form material_frontend %}
...
<div class="left-panel">
    <div class="card">
        <form role="form" method="POST">
            <div class="card-bend primary center-align">
            ...
            <div class="card-action">
                <div class="row">
                    ...
                    <div class="col s9 right-align">
                        ...
                        <button type="submit" name="_done" class="btn primary white-text btn-flat">Terminar</button>
                    </div>
                    {% endblock %}
                </div>
            </div>
