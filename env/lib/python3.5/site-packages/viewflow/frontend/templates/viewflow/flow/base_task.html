...
<div class="left-panel">
    <div class="card">
        <div class="card-content">
            <div class="card-bend primary center-align hide-on-med-and-down {% if activation.task.finished %}disabled{% endif %}">
            ...
            <div class="row">
                ...
                <div class="col s12 m4 l4">
                    ...
                    <ul>
                        ...
                        {% empty %}
                        <li class="grey-text">No hay tareas previas</li>
                        {% endfor %}
                    </ul>
                    <h5>Tarea siguiente</h5>
                    <ul>
                        ...
                        {% empty %}
                        <li class="grey-text">No hay más tareas</li>
                        {% endfor %}
                    </ul>
                </div>
            </div>
