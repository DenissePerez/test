        ...
        <form role="form" method="POST">
            ...
            <div class="card-content">
                <div class="card-bend primary center-align hide-on-med-and-down {% if process.finished %}disabled{% endif %}">
                    ...
                    <h6>{% if process.finished %}Finalizado{% else %}en progreso{% endif %}</h6>
                </div>
                <div class="card-title black-text">Cancel {{ flow_class.process_title }} #{{ process.pk }} and {{ active_tasks|length }} tareas</div>
                ...
                <table class="table bordered">
                    <thead>
                        ...
                        <th>Nombre</th>
                        <th >Descripción</th>
                        <th class="hide-on-small-only">Iniciado</th>
                        <th>Estado</th>
                        <th>&nbsp;</th>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge red" style="width:100px">NO CANCELABLE</span>
                                {% endif %}
                            </td>
                        </tr>
                        {% endfor %}
            ...
            <div class="card-action">
                <div class="right-align">
                    <button type="submit" name="_cancel_process" class="btn  btn-flat {% if uncancelable_tasks %}disabled{% endif %}" {% if uncancelable_tasks %}disabled{% endif %}>Cancelar</button>
                </div>
            </div>
        </form>
    </div>
